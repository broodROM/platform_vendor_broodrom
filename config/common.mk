...
# init.d support
PRODUCT_COPY_FILES += \
    vendor/broodROM/prebuilt/common/etc/init.d/00banner:system/etc/init.d/00banner \
    vendor/broodROM/prebuilt/common/bin/sysinit:system/bin/sysinit

# userinit support
PRODUCT_COPY_FILES += \
    vendor/broodROM/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit

# SELinux filesystem labels
PRODUCT_COPY_FILES += \
    vendor/broodROM/prebuilt/common/etc/init.d/50selinuxrelabel:system/etc/init.d/50selinuxrelabel
...
PRODUCT_PACKAGE_OVERLAYS += vendor/broodROM/overlay/common
